...
<template>
    ...
    <v-card class="text-left d-flex flex-row pa-8" outlined flat tile>
        ...
        <v-btn color="teal" dark @click="onClick" >Save</v-btn>
    </v-card>-->
...
export default {
    ...
    methods:{
        ...
        setDate() {
            if (this.mode == 'edit') {
                console.log('setDate_edit', this.$store.getters.getPaymentItem(this.id).date);
        ...
        onClick(){
            ...
            if (this.mode == 'edit') {
             ...
             console.log('this.$root',this.$parent.$parent)
            this.$parent.$parent.onCloseClick()
        },
        onSave() {
            console.log('onSave')
