<template>
  <div id="app">
    ...
    <div class="wrapper">
      <p @click="onClickedAddPaymentForm"><router-link to="/add/payment/Food?value=200" >Завести строку Food значением 200</router-link></p>
      
      <p @click="onClickedAddPaymentForm"><router-link to="/add/payment/Transport?value=50" >Завести строку Transport значением 50</router-link></p>
      
      <p @click="onClickedAddPaymentForm"><router-link to="/add/payment/0?value=0" >Сбросить значения в форме ввода</router-link></p>
      ...
      <!-- <router-view v-if="modalWindowName" :settings="settings"></router-view> -->
